  ...
  return (
    <Container className="text-center" style={{ width: "600px" }}>
      <Col>
        ...
        <Row className="m-3">
          <h4>
            แบบสอบถามสำหรับผู้ที่สนใจเป็นตำแหน่ง Area Leader กับ Goodsmeal{" "}
          </h4>
        </Row>
        <Row className="m-3">
          <h6>
              ...
              <Container>
                ...
                <Row>
                  ...
                  <Form.Group className="p-2">
                    ...
                    >
                      <option>กรุณาระบุยานพาหนะ</option>
